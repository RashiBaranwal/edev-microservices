...
LABEL org.opencontainers.image.title "edev-microservices/${SERVICE_NAME}"
LABEL org.opencontainers.image.description "Contact and Mail Service for evolvedev.info"
LABEL org.opencontainers.image.url="https://github.com/soham-basak/edev-microservices"
